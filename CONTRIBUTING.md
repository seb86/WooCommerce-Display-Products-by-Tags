# Contribute To WooCommerce Display Products by Tags
...
GitHub is for *bug reports and contributions only* - if you have a support question or a request, don't post here. Use the [WordPress.org](https://wordpress.org/support/plugin/woocommerce-display-products-by-tags) for community support.
...
* Push the changes to your fork and submit a pull request to the 'dev' branch of the WooCommerce Display Products by Tag repository.
...
* [Community Support](https://wordpress.org/support/plugin/woocommerce-display-products-by-tags)
