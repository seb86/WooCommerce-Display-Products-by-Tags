# main config
PLUGINSLUG="woocommerce-display-products-by-tags" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="woocommerce-display-products-by-tags.php" # this should be the name of your main php file in the wordpress plugin
